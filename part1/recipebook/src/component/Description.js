...
import React from 'react';
 ...
 function RecipeAuthor() {
   let authorLink="https://www.vahrehvah.com/";
   let authorPhoto="https://yt3.ggpht.com/-INrY2l94xxg/AAAAAAAAAAI/AAAAAAAAAAA/v1dQsFQuMNg/s900-c-k-no/photo.jpg"
   let authorName="Sanjay Thuma";
   return(
      <div className = {styles.recipeAuthorBlock}>
      <img src={authorPhoto} alt = "VahChef" className={styles.imageUpdates} />
      <div>
         <h3>{authorName}</h3>
         <a href={authorLink}>VahRehVah</a> 
      </div>
   </div>
   )
}
